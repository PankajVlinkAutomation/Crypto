...
import com.chasmlabs.automation.dto.primetrust.response.GetBalanceResponseDto;
...
@Slf4j
public class GetBalanceManager extends ApiManager {

    private Response response;
    private GetBalanceResponseDto responseDTO;
    private final List<Header> headerList = new ArrayList<>();
    Map<String, String> queryParams = new HashMap<>();
    Map<String, String> pathParams = new HashMap<>();

    public GetBalanceManager(String loginPath){
    ...
    @Override
    public GetBalanceResponseDto getResponsePojo() {
